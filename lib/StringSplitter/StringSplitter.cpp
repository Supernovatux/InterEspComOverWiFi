/*
        StringSplitter.h - Library for splitting strings based on a char
...
StringSplitter::StringSplitter(String s, char c, unsigned int limit) {
  count = countOccurencesOfChar(s, c) +
          1; // fix for no elements, ie return input string
...
int StringSplitter::getItemCount() { return count; }
